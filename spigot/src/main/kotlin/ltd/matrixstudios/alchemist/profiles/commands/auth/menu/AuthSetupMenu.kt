...
class AuthSetupMenu(val player: Player) : Menu(player)
{
    ...
    override fun getButtons(player: Player): MutableMap<Int, Button>
    {
        ...
        buttons[22] = PlaceholderButton(
            Material.PAINTING, mutableListOf(
                Chat.format(" "),
        ...
        buttons[30] = SimpleActionButton(
            ...
            val troublesComponent = Component.text(
                ...
                .hoverEvent(HoverEvent.showText(Component.text(Chat.format("&7Your secret (input in the app): &f${profile.getAuthStatus().secret}"))))
