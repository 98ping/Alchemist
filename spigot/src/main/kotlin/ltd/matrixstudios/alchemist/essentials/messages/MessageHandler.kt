...
object MessageHandler
{
    ...
    private val STAFF_MESSAGE_FORMAT_FROM: String =
        AlchemistSpigotPlugin.instance.config.getString("message.staff_message_format_from")
    private val STAFF_MESSAGE_FORMAT_TO: String =
        AlchemistSpigotPlugin.instance.config.getString("message.staff_message_format_to")
